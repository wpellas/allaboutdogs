    ...
    <footer class="hidden md:block static bottom-0 w-full h-60 text-center bg-white text-amber-900 px-[10%] shadow-[0px_-10px_15px_-3px_rgba(0,0,0,0.1)]">
        <div class="flex w-full h-full">
            ...
            <div class="w-2/3 h-full flex flex-wrap">
                ...
                <?php endif; ?>
                    <p class="text-left text-secondary-500">Github: <a class="text-secondary-300 hover:text-primary-100" href="https://github.com/wpellas">wpellas</a></p>
                </div>
                <div class="w-1/2 h-1/2 p-4">
                    <p class="text-left text-secondary-500">Portfolio: <a class="text-secondary-300 hover:text-primary-100" href="https://williampellas.com/">https://williampellas.com/</a></p>
                    <p class="text-left text-secondary-500">LinkedIn: <a class="text-secondary-300 hover:text-primary-100" href="https://www.linkedin.com/in/williampellas/">William Pellas</a></p>
                </div>
            </div>
        </div>  
    </footer>
